...
SECRET_KEY = 'django-insecure-!je&+%^jp6ukaz#)ap-71-%frlj+%duo1m4hm!4jhti(uxv(ce'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'context_processors.context_processors.contact_info',
                'context_processors.context_processors.notifications_exist',
            ],
        },
    },
]
